  ...
  return (
    <Container className="mt-3 py-2">
      <Card className="cntCard mx-auto border-0 mb-3">
        <Card.Header
          className="cntCardHeader"
          style={{
            backgroundColor: '#8c1414',
            borderBottom: '1px solid #bfa552',
          }}
        >
          Contact Vector Electrical
        </Card.Header>
        <Card.Body className="cntCardBody">
          <Card.Text>
            If you'd like additional information or to schedule an appointment,
          ...
          <Row className="justify-content-center">
            ...
            <Col className="" md={4}>
              <FontAwesomeIcon
                className="fab mx-2"
                icon={faEnvelope}
                style={{ height: '1.25em', width: '2em' }}
              />
              P.O. Box 61 Hollis, NH 03049
            </Col>
            <Col className="" md={3}>
              <FontAwesomeIcon
                className="fab mx-2"
