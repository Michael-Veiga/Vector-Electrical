            ...
            <Card className="shadow mx-auto my-4" style={{border: "2px solid #bfa552", backgroundColor: "#fcfbf7"}}>
                <Row className="no-gutters">
                    ...
                    <Col md={9}>
                        ...
                        <hr className="my-2 mr-3" style={{borderTop: "2px solid #8c1414"}}/>
                        <Card.Body className="parCardBody py-0 text-center">
                            ...
                            <Card.Link style={{textDecoration: "underline"}} target="_blank" href="https://www.generac.com/all-products/generators/home-backup-generators#?cat=6&cat=214&cat=217&cat=249">More Information on Generac Generators</Card.Link>
                        </Card.Body>
                    </Col>
                </Row>
            </Card>
                ...
                <Row className="no-gutters">
                    ...
                    <Col md={9}>
                        ...
                        <Card.Body className="parCardBody py-0 text-center">
                            ...
                            <Card.Link style={{textDecoration: "underline"}}  target="_blank" href="https://www.rockwellautomation.com/en-dk/products/hardware/allen-bradley/programmable-controllers/all-products.html#large-control-systems">More Information on Allen Bradley Control Systems</Card.Link>
                        </Card.Body>
                    </Col>
                </Row>
            </Card>
