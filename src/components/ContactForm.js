...
handleChange = (param, e) => {
  ...
  render() {
    return(
        <div>
            <ToastContainer />
            <Form className="cForm py-3" onSubmit={this.handleSubmit.bind(this)} id="contact-form" style={{margin: '0 auto', width: "100%"}}>
              ...
              <Form.Group className="px-5" controlId="formBasicName">
                ...
                <Form.Control required type="text" name="name" value={this.state.name}
                 onChange={this.handleChange.bind(this, 'name')} placeholder="John Smith"/>
              </Form.Group>
    
              <Form.Group className="px-5" controlId="formBasicEmail">
                <Form.Label className="">Email</Form.Label>
                <Form.Control required type="email" name="email" placeholder="john@gmail.com" value={this.state.email} onChange={this.handleChange.bind(this, 'email')}/>
              </Form.Group>
    
              <Form.Group className="px-5" controlId="formBasicSubject">
                <Form.Label className="">Subject</Form.Label>
                  <Form.Control required name="subject" type="text" placeholder="Quote for Generac Generator" value={this.state.subject} onChange={this.handleChange.bind(this, 'subject')}/>
              </Form.Group>
    
              <Form.Group className="px-5" controlId="formBasicMessage">
                <Form.Label className="">Message</Form.Label>
                <Form.Control required name="message" type="textarea" row="3" placeholder="I'm looking for an estimate..." value={this.state.message} onChange={this.handleChange.bind(this, 'message')}/>
              </Form.Group>
